...
-   (Optional) Set up optional environment variables in your local shell or in a .env (if you use .env, put it in the main repo top level next to `Dockerfile`, `main.sh` will load it)
